        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 border-b border-[#C4852B]/20 pb-8">
          <div>
            <span className="text-[10px] text-[#C4852B] font-mono tracking-widest uppercase mb-2 block font-bold">
              18K SOLID GOLD & DIAMOND RINGS
            </span>
            <h1 className="text-3xl md:text-5xl font-bold uppercase">{t.header.rings}</h1>
          </div>
          <p className="text-xs text-[#626667] max-w-sm mt-4 md:mt-0">
            {language === 'fa' 
              ? 'انگشترهای طلا و الماس با شناسنامه اصالت و عیار ۱۸، ساخته شده بر اساس هویت تصویری برند.' 
              : 'Certified 18K solid gold rings featuring VVS diamond settings and natural agate stone work.'}
          </p>
        </div>
