...
export default function ShopPage() {
  ...
  const categories = [
    { id: 'all', nameFa: 'همه محصولات', nameEn: 'All Creations', nameAr: 'جميع المنتجات' },
    { id: 'rings', nameFa: 'انگشتر', nameEn: 'Rings', nameAr: 'خواتم' },
    { id: 'necklaces', nameFa: 'گردنبند', nameEn: 'Necklaces', nameAr: 'قلائد' },
    { id: 'bracelets', nameFa: 'دستبند', nameEn: 'Bracelets', nameAr: 'أساور' },
    { id: 'earrings', nameFa: 'گوشواره', nameEn: 'Earrings', nameAr: 'أقراط' }
  ];
    ...
    <div className="py-16 md:py-28 bg-[#FFFFFF] dark:bg-[#FAF9F5] text-zinc-950 min-h-screen transition-colors duration-500">
      <div className="container mx-auto px-4 md:px-12">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-16">
          {categories.map((cat) => {
            const catName = language === 'fa' ? cat.nameFa : language === 'ar' ? cat.nameAr : cat.nameEn;
            return (
              <button
                key={cat.id}
