...
try {
    $products = Invoke-RestMethod -Uri "http://nafiseebadijewellery.com/api/admin/products" -Method Get -Headers $headers
...
try {
    $pubProducts = Invoke-RestMethod -Uri "http://nafiseebadijewellery.com/api/products" -Method Get -Headers $headers
...
try {
    $pubNoToken = Invoke-RestMethod -Uri "http://nafiseebadijewellery.com/api/products" -Method Get
